...
export declare const NormalizedCallArg: GenericSchema<import("@iota/bcs").EnumInputShape<{
    ...
    Pure: number[];
}>, import("@iota/bcs").EnumOutputShapeWithKeys<{
    ...
    Pure: number[];
}, never>, import("valibot").BaseIssue<unknown>>;
