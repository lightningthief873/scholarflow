...
__export(keypair_exports, {
  IOTA_PRIVATE_KEY_PREFIX: () => IOTA_PRIVATE_KEY_PREFIX,
  Keypair: () => Keypair,
  LEGACY_PRIVATE_KEY_SIZE: () => LEGACY_PRIVATE_KEY_SIZE,
  PRIVATE_KEY_SIZE: () => PRIVATE_KEY_SIZE,
  Signer: () => Signer,
  decodeIotaPrivateKey: () => decodeIotaPrivateKey,
  encodeIotaPrivateKey: () => encodeIotaPrivateKey
});
...
function encodeIotaPrivateKey(bytes, scheme) {
  ...
  return import_bech32.bech32.encode(IOTA_PRIVATE_KEY_PREFIX, import_bech32.bech32.toWords(privKeyBytes));
}
