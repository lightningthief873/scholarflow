...
export declare const IOTA_WALLET_NAME = "IOTA Wallet";
export declare const DEFAULT_STORAGE: import("zustand/middleware.js").StateStorage;
export declare const DEFAULT_STORAGE_KEY = "iota-dapp-kit:wallet-connection-info";
...
export declare const WALLET_DOWNLOAD_URL: string;
