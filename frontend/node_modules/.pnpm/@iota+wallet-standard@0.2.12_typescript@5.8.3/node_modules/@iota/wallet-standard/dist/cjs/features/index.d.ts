 ...
 */
export type IotaFeatures = IotaSignPersonalMessageFeature & IotaSignAndExecuteTransactionFeature & IotaSignTransactionFeature & Partial<IotaReportTransactionEffectsFeature>;
export type IotaWalletFeatures = StandardConnectFeature & StandardEventsFeature & IotaFeatures & Partial<StandardDisconnectFeature>;
 ...
 */
export type WalletWithRequiredFeatures = WalletWithFeatures<MinimallyRequiredFeatures & Partial<IotaFeatures> & Partial<StandardDisconnectFeature> & IdentifierRecord<unknown>>;
