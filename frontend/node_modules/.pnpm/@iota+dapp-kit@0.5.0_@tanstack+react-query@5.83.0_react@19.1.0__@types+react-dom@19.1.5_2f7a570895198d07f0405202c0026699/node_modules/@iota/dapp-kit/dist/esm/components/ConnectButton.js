...
function AccountDropdownMenu({ currentAccount, size = "lg" }) {
  ...
  return /* @__PURE__ */ jsxs(DropdownMenu.Root, { modal: false, children: [
    /* @__PURE__ */ jsx6(StyleMarker, { children: /* @__PURE__ */ jsx6(DropdownMenu.Trigger, { asChild: true, children: /* @__PURE__ */ jsxs(Button, { size, className: connectedAccount, children: [
      /* @__PURE__ */ jsx6(Text, { mono: true, weight: "bold", children: currentAccount.label ?? formatAddress(currentAccount.address) }),
      /* @__PURE__ */ jsx6(ChevronIcon, {})
    ] }) }) }),
    /* @__PURE__ */ jsx6(DropdownMenu.Portal, { children: /* @__PURE__ */ jsx6(StyleMarker, { className: menuContainer, children: /* @__PURE__ */ jsxs(DropdownMenu.Content, { className: menuContent, children: [
      /* @__PURE__ */ jsx6("div", { className: scrollableContent, children: accounts.map((account) => /* @__PURE__ */ jsx6(
...
function AccountDropdownMenuItem({
  ...
  return /* @__PURE__ */ jsxs(
    DropdownMenu.Item,
    {
      ...
      children: [
        /* @__PURE__ */ jsx6(Text, { mono: true, children: account.label ?? formatAddress(account.address) }),
        active ? /* @__PURE__ */ jsx6(CheckIcon, {}) : null
      ]
    }
  );
}
    ...
    mutationFn: async ({ wallet, accountAddress, ...connectArgs }) => {
      try {
        ...
        const connectedIotaAccounts = connectResult.accounts.filter(
          (account) => account.chains.some(isSupportedChain)
        );
...
function ConnectionStatus({
  ...
  return /* @__PURE__ */ jsxs2("div", { className: container2, children: [
    ...
    hadConnectionError ? /* @__PURE__ */ jsx11("div", { className: retryButtonContainer, children: /* @__PURE__ */ jsx11(
      Button,
      {
        type: "button",
        variant: "primary",
...
function GettingStarted() {
  return /* @__PURE__ */ jsxs4("div", { className: container4, children: [
    /* @__PURE__ */ jsx13(Heading, { as: "h2", children: "Get Started with IOTA" }),
    /* @__PURE__ */ jsxs4("div", { className: content2, children: [
      /* @__PURE__ */ jsx13(InfoSection, { title: "Install the IOTA Wallet Extension", children: "We recommend pinning IOTA Wallet to your taskbar for quicker access." }),
      ...
      /* @__PURE__ */ jsx13("div", { className: installButtonContainer, children: /* @__PURE__ */ jsx13(Button, { variant: "primary", asChild: true, children: /* @__PURE__ */ jsx13(
        "a",
        {
...
function WalletListItem({ name, icon: icon2, onClick, isSelected = false }) {
  return /* @__PURE__ */ jsx16("li", { className: container7, children: /* @__PURE__ */ jsxs6(
    "button",
    {
      ...
      onClick,
      children: [
        typeof icon2 === "string" ? /* @__PURE__ */ jsx16("img", { className: walletIcon2, src: icon2, alt: `${name} logo` }) : icon2,
...
function WalletList({ selectedWalletName, onPlaceholderClick, onSelect }) {
  ...
  return /* @__PURE__ */ jsx17("ul", { className: container6, children: wallets.length > 0 ? wallets.map((wallet) => /* @__PURE__ */ jsx17(
    ...
    {
      name: "IOTA Wallet",
      icon: /* @__PURE__ */ jsx17(IotaIcon, { className: icon }),
...
function ConnectModal({ trigger, open, defaultOpen, onOpenChange }) {
  ...
  return /* @__PURE__ */ jsxs7(Dialog.Root, { open: open ?? isModalOpen, onOpenChange: handleOpenChange, children: [
    /* @__PURE__ */ jsx18(Dialog.Trigger, { asChild: true, children: trigger }),
    /* @__PURE__ */ jsx18(Dialog.Portal, { children: /* @__PURE__ */ jsx18(StyleMarker, { children: /* @__PURE__ */ jsx18(Dialog.Overlay, { className: overlay, children: /* @__PURE__ */ jsxs7(Dialog.Content, { className: content, "aria-describedby": void 0, children: [
      /* @__PURE__ */ jsxs7(
        "div",
        {
      ...
      /* @__PURE__ */ jsxs7(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx18("div", { className: backButtonContainer, children: /* @__PURE__ */ jsx18(
              IconButton,
              {
                type: "button",
                "aria-label": "Back",
...
function ConnectButton({
  ...
  return currentAccount ? /* @__PURE__ */ jsx19(AccountDropdownMenu, { currentAccount, size }) : /* @__PURE__ */ jsx19(
    ConnectModal,
    {
      trigger: /* @__PURE__ */ jsx19(StyleMarker, { children: /* @__PURE__ */ jsx19(Button, { ...buttonProps, size, children: connectText }) })
    }
  );
}
export {
