...
// src/components/connect-modal/views/GetTheWallet.tsx
var GetTheWallet_exports = {};
__export(GetTheWallet_exports, {
  GetTheWalletView: () => GetTheWalletView
});
module.exports = __toCommonJS(GetTheWallet_exports);
...
// src/components/connect-modal/views/GetTheWallet.css.ts
var button = "GetTheWallet_button__1iomrym3";
var container = "GetTheWallet_container__1iomrym0";
var content = "GetTheWallet_content__1iomrym1";
var icon = "GetTheWallet_icon__1iomrym4";
var text = "GetTheWallet_text__1iomrym2";

// src/components/connect-modal/views/GetTheWallet.tsx
var import_jsx_runtime4 = require("react/jsx-runtime");
function GetTheWalletView() {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: container, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: content, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(IotaIcon, { className: icon, width: 48, height: 48 }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: text, children: "Don't have a wallet yet?" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("a", { href: WALLET_DOWNLOAD_URL, target: "_blank", rel: "noopener noreferrer", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Button, { size: "md", variant: "primary", className: button, children: [
      "Get the IOTA wallet",
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ArrowTopRightIcon, { width: 16, height: 16 })
    ] }) })
  ] });
}
//# sourceMappingURL=GetTheWallet.js.map
