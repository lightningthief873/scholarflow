...
var container = "WalletList_container__1tkdegw0";
...
var container2 = "WalletListItem_container__1vrvezk0";
var selectedWalletItem = "WalletListItem_selectedWalletItem__1vrvezk2";
var walletIcon = "WalletListItem_walletIcon__1vrvezk3";
...
function WalletListItem({ name, icon: icon2, onClick, isSelected = false }) {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("li", { className: container2, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    "button",
    {
      ...
      onClick,
      children: [
        typeof icon2 === "string" ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("img", { className: walletIcon, src: icon2, alt: `${name} logo` }) : icon2,
...
function WalletList({ selectedWalletName, onPlaceholderClick, onSelect }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("ul", { className: container, children: wallets.length > 0 ? wallets.map((wallet) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    ...
    {
      name: "IOTA Wallet",
      icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(IotaIcon, { className: icon }),
