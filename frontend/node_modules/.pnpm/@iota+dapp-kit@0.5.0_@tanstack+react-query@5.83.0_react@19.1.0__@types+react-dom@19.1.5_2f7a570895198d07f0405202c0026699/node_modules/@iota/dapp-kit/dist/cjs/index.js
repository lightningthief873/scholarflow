...
__export(index_exports, {
  ...
  IotaClientContext: () => IotaClientContext,
  IotaClientProvider: () => IotaClientProvider,
  ...
  useIotaClient: () => useIotaClient,
  useIotaClientContext: () => useIotaClientContext,
  useIotaClientInfiniteQuery: () => useIotaClientInfiniteQuery,
  useIotaClientMutation: () => useIotaClientMutation,
  useIotaClientQueries: () => useIotaClientQueries,
  useIotaClientQuery: () => useIotaClientQuery,
...
var import_wallet_standard = require("@iota/wallet-standard");
    ...
    mutationFn: async ({ wallet, accountAddress, ...connectArgs }) => {
      try {
        ...
        const connectedIotaAccounts = connectResult.accounts.filter(
          (account) => account.chains.some(import_wallet_standard.isSupportedChain)
        );
...
var import_wallet_standard2 = require("@iota/wallet-standard");
function getRegisteredWallets(preferredWallets, walletFilter) {
  ...
  const iotaWallets = wallets.filter(
    (wallet) => (0, import_wallet_standard2.isWalletWithRequiredFeatureSet)(wallet) && (!walletFilter || walletFilter(wallet))
  );
  return [
...
var headingVariants = (0, import_createRuntimeFn.createRuntimeFn)({ defaultClassName: "Heading__12b5l8i0", variantClassNames: { size: { sm: "Heading_headingVariants_size_sm__12b5l8i1", md: "Heading_headingVariants_size_md__12b5l8i2", lg: "Heading_headingVariants_size_lg__12b5l8i3", xl: "Heading_headingVariants_size_xl__12b5l8i4" }, weight: { normal: "Heading_headingVariants_weight_normal__12b5l8i5", bold: "Heading_headingVariants_weight_bold__12b5l8i6" }, truncate: { true: "Heading_headingVariants_truncate_true__12b5l8i7" } }, defaultVariants: { size: "lg", weight: "bold" }, compoundVariants: [] });
...
function ConnectionStatus({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: container2, children: [
    ...
    hadConnectionError ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: retryButtonContainer, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
      Button,
      {
        type: "button",
        variant: "primary",
...
function GettingStarted() {
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: container4, children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(Heading, { as: "h2", children: "Get Started with IOTA" }),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: content2, children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(InfoSection, { title: "Install the IOTA Wallet Extension", children: "We recommend pinning IOTA Wallet to your taskbar for quicker access." }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: installButtonContainer, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(Button, { variant: "primary", asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
        "a",
        {
...
// src/components/icons/IotaIcon.tsx
...
function WalletListItem({ name, icon: icon2, onClick, isSelected = false }) {
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("li", { className: container7, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
    "button",
    {
      ...
      onClick,
      children: [
        typeof icon2 === "string" ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("img", { className: walletIcon2, src: icon2, alt: `${name} logo` }) : icon2,
...
function WalletList({ selectedWalletName, onPlaceholderClick, onSelect }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("ul", { className: container6, children: wallets.length > 0 ? wallets.map((wallet) => /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
    ...
    {
      name: "IOTA Wallet",
      icon: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(IotaIcon, { className: icon }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Dialog.Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(StyleMarker, { children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Dialog.Overlay, { className: overlay, children: /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(Dialog.Content, { className: content, "aria-describedby": void 0, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { className: backButtonContainer, children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
              IconButton,
              {
                type: "button",
                "aria-label": "Back",
...
function AccountDropdownMenu({ currentAccount, size = "lg" }) {
  const { mutate: disconnectWallet } = useDisconnectWallet();
  const accounts = useAccounts();
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)(DropdownMenu.Root, { modal: false, children: [
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(StyleMarker, { children: /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(DropdownMenu.Trigger, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)(Button, { size, className: connectedAccount, children: [
      /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Text, { mono: true, weight: "bold", children: currentAccount.label ?? (0, import_utils.formatAddress)(currentAccount.address) }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(DropdownMenu.Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(StyleMarker, { className: menuContainer, children: /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)(DropdownMenu.Content, { className: menuContent, children: [
      /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("div", { className: scrollableContent, children: accounts.map((account) => /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
...
function AccountDropdownMenuItem({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)(
    DropdownMenu.Item,
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Text, { mono: true, children: account.label ?? (0, import_utils.formatAddress)(account.address) }),
...
function ConnectButton({
  ...
  return currentAccount ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(AccountDropdownMenu, { currentAccount, size }) : /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
    ConnectModal,
    {
      trigger: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(StyleMarker, { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Button, { ...buttonProps, size, children: connectText }) })
    }
  );
}
...
var IotaClientContext = (0, import_react9.createContext)(null);
var DEFAULT_NETWORKS = {
  localnet: { url: (0, import_client.getNetwork)(import_client.Network.Localnet)?.url }
};
var DEFAULT_CREATE_CLIENT = function createClient(_name, config) {
  if ((0, import_client.isIotaClient)(config)) {
    return config;
  }
  return new import_client.IotaClient(config);
};
function IotaClientProvider(props) {
  ...
  const ctx = (0, import_react9.useMemo)(() => {
    return {
      ...
      config: networks[currentNetwork] instanceof import_client.IotaClient ? null : networks[currentNetwork],
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(IotaClientContext.Provider, { value: ctx, children });
}
...
var SIGN_FEATURES = ["iota:signTransaction"];
var DEFAULT_WALLET_FILTER = (wallet) => SIGN_FEATURES.some((feature) => wallet.features[feature]);
var DEFAULT_PREFERRED_WALLETS = [IOTA_WALLET_NAME];
...
function useAutoConnectWallet() {
  ...
  const [clientOnly, setClientOnly] = (0, import_react10.useState)(false);
  (0, import_react10.useLayoutEffect)(() => {
    setClientOnly(true);
  }, []);
  const { data, isError } = (0, import_react_query4.useQuery)({
    queryKey: [
      "@iota/dapp-kit",
      "autoconnect",
      {
...
var import_ed25519 = require("@iota/iota-sdk/keypairs/ed25519");
var import_transactions = require("@iota/iota-sdk/transactions");
var import_utils2 = require("@iota/iota-sdk/utils");
var import_wallet_standard3 = require("@iota/wallet-standard");
var import_react12 = require("react");

// src/hooks/useIotaClient.ts
var import_react11 = require("react");
function useIotaClientContext() {
  const iotaClient = (0, import_react11.useContext)(IotaClientContext);
  if (!iotaClient) {
    throw new Error(
...
function registerUnsafeBurnerWallet(iotaClient) {
  ...
  const account = new import_wallet_standard3.ReadonlyWalletAccount({
  ...
  class UnsafeBurnerWallet {
    ...
    get chains() {
      return import_wallet_standard3.SUPPORTED_CHAINS;
    }
    get accounts() {
      return [account];
    }
...
var import_wallet_standard4 = require("@iota/wallet-standard");
...
function useWalletsChanged(preferredWallets, walletFilter) {
  ...
  (0, import_react14.useEffect)(() => {
    const walletsApi = (0, import_wallet_standard4.getWallets)();
    ...
    (0, import_middleware.persist)(
      (set, get) => ({
        ...
        updateWalletAccounts(accounts) {
          ...
          set(() => ({
            accounts,
            currentAccount: currentAccount && accounts.find(
...
// src/hooks/useIotaClientMutation.ts
...
var import_utils4 = require("@iota/iota-sdk/utils");
var import_wallet_standard5 = require("@iota/wallet-standard");
...
function useSignAndExecuteTransaction({
  ...
  return (0, import_react_query10.useMutation)({
    ...
    mutationFn: async ({ transaction, ...signTransactionArgs }) => {
      ...
      const { signature, bytes } = await (0, import_wallet_standard5.signTransaction)(currentWallet, {
        ...signTransactionArgs,
        transaction: {
          async toJSON() {
...
var import_wallet_standard6 = require("@iota/wallet-standard");
...
function useSignTransaction({
  ...
  return (0, import_react_query12.useMutation)({
    ...
    mutationFn: async ({ transaction, ...signTransactionArgs }) => {
      ...
      const { bytes, signature } = await (0, import_wallet_standard6.signTransaction)(currentWallet, {
        ...signTransactionArgs,
        transaction: {
          toJSON: async () => {
            return typeof transaction === "string" ? transaction : await transaction.toJSON({
