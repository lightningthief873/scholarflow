...
function GetTheWalletView() {
  return /* @__PURE__ */ jsxs("div", { className: container, children: [
    /* @__PURE__ */ jsxs("div", { className: content, children: [
      /* @__PURE__ */ jsx4(IotaIcon, { className: icon, width: 48, height: 48 }),
      /* @__PURE__ */ jsx4("p", { className: text, children: "Don't have a wallet yet?" })
    ] }),
    /* @__PURE__ */ jsx4("a", { href: WALLET_DOWNLOAD_URL, target: "_blank", rel: "noopener noreferrer", children: /* @__PURE__ */ jsxs(Button, { size: "md", variant: "primary", className: button, children: [
      "Get the IOTA wallet",
      /* @__PURE__ */ jsx4(ArrowTopRightIcon, { width: 16, height: 16 })
    ] }) })
  ] });
}
export {
