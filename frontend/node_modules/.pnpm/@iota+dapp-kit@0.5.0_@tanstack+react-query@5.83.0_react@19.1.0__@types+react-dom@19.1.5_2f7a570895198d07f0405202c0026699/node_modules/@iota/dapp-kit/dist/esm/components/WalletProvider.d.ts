...
export declare function WalletProvider({ preferredWallets, walletFilter, storage, storageKey, enableUnsafeBurner, autoConnect, theme, children, }: WalletProviderProps): import("react/jsx-runtime").JSX.Element;
